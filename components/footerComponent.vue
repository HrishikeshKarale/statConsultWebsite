<template>
	<footer class="p-4 bg-stone-800 sm:p-6 dark:bg-stone-800">
	<div class="md:flex md:justify-between">
		<div class="mb-6 md:mb-0">
			<a href="https://flowbite.com" class="flex items-center">
				<img src="../assets/logo.svg" class="mr-3 h-8" alt="FlowBite Logo">
				<span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Data Labs</span>
			</a>
		</div>
		...
		<div class="sm:flex sm:items-center sm:justify-between">
	        ...
	        <font-awesome-icon icon="fa-brands fa-twitter" class="p-2" />
				</a>
				<a href="#" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
